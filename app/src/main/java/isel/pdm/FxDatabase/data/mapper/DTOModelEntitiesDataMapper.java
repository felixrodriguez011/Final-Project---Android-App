package isel.pdm.FxDatabase.data.mapper;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

import isel.pdm.FxDatabase.data.api.ITMDbServiceAPI;
import isel.pdm.FxDatabase.data.api.entity.CreditsListingDTO;
import isel.pdm.FxDatabase.data.api.entity.GenreListingDTO;
import isel.pdm.FxDatabase.data.api.entity.MovieDTO;
import isel.pdm.FxDatabase.data.api.entity.MovieListingDTO;
import isel.pdm.FxDatabase.model.Actor;
import isel.pdm.FxDatabase.model.Crew;
import isel.pdm.FxDatabase.model.Genre;
